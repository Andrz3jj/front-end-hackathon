      ...
      <div className="bg-slate-800 text-white min-h-screen flex items-center justify-center">
        <div className="container mx-auto p-4 pt-6 md:p-6 lg:p-12">
          <div className="bg-slate-700 border border-slate-600 rounded p-8 text-center w-full max-w-md mx-auto">
            <span className="text-3xl">Dodaj nowy post</span><br/><br/>
            <span className="block text-left">Tytuł</span>
            <form>
                <input type="text" 
                ...
                <span className="block text-left mt-4">Opis</span>
                ...
                <input type="submit" value="Dodaj" className="mt-4 text-lg bg-blue-600 rounded p-4 w-full hover:bg-blue-700 transition focus:bg-blue-800"/>
            </form>
          </div>
        </div>
      </div>
