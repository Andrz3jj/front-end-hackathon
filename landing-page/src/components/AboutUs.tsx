    ...
    return (
        <>
            <div className="bg-slate-800 text-white min-h-screen">
               <div className="flex items-center justify-center h-full p-16 container">
                        ...
                        <div className="text-lg text-center pt-16">
                            ...
                            <ul>
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    ...
                                    <div className="bg-slate-700 border border-slate-600 rounded flex items-center"> 
                                        <img src={Janek} className="w-28 m-4 rounded-lg" />
                                        <div className="ml-4 text-white flex flex-col items-center"> 
                                    ...
                                    <div className="bg-slate-700 border border-slate-600 rounded flex items-center">
                                        <img src={Tomek} className="w-28 m-4 rounded-lg" />
                                        <div className="ml-4 text-white flex flex-col items-center"> 
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="bg-slate-700 border border-slate-600 rounded flex items-center">
                                        <img src={Kamil} className="w-28 m-4 rounded-lg" />
                                              <div className="ml-4 text-white flex flex-col items-center">
                                    ...
                                    <div className="bg-slate-700 border border-slate-600 rounded flex items-center">
                                        <img src={Kacper} className="w-28 m-4 rounded-lg" />
                                            <div className="ml-4 text-white flex flex-col items-center">
